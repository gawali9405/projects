    ...
    <div className="flex h-screen overflow-hidden bg-gray-100">
      ...
      <aside className="w-[300px] bg-white py-20 px-15 flex-shrink-0 border-r border-gray-300 h-full overflow-y-auto ">
        ...
        <nav className="flex flex-col gap-2 text-[16px]">
          <Link to="/dashboard/profile" className="hover:text-green-600">
            Profile
          </Link>
          ...
          <Link to="/dashboard/my-orders" className="hover:text-green-600">
            My Order
          </Link>
          <Link to="/dashboard/saved-address" className="hover:text-green-600">
            Saved Address
          </Link>
          <button
            onClick={() => dispatch(logout())}
            className="text-left text-red-500 hover:text-red-700 mt-2"
          >
            Logout
          </button>
        </nav>
